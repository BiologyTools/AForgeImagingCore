    ...
    public class SaturationCorrection : BaseInPlacePartialFilter
    {
        ...
        public float AdjustValue
        {
            ...
            set
            {
                ...
                if ( adjustValue > 0 )
                {
                    baseFilter.InSaturation  = new AForge.Range( 0.0f, 1.0f - adjustValue );
                    baseFilter.OutSaturation = new AForge.Range( adjustValue, 1.0f );
                }
                else
                {
                    baseFilter.InSaturation  = new AForge.Range( -adjustValue, 1.0f );
                    baseFilter.OutSaturation = new AForge.Range( 0.0f, 1.0f + adjustValue );
                }
            }
        }
