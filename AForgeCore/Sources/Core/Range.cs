...
namespace AForge
{
    ...
    /// AForge.Range range1 = new AForge.Range( 0.25f, 1.5f );
    /// // create [1.00, 2.25] range
    /// AForge.Range range2 = new AForge.Range( 1.00f, 2.25f );
    ...
    public struct Range
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AForge.Range"/> structure.
        /// </summary>
        /// 
        ...
        /// </summary>
        /// 
        /// <param name="range">AForge.Range to check.</param>
        /// 
        /// <returns><b>True</b> if the specified range is inside of the range or
        /// <b>false</b> otherwise.</returns>
        /// 
        public bool IsInside( AForge.Range range )
        {
        ...
        /// </summary>
        /// 
        /// <param name="range">AForge.Range to check for overlapping.</param>
        /// 
        /// <returns><b>True</b> if the specified range overlaps with the range or
        /// <b>false</b> otherwise.</returns>
        /// 
        public bool IsOverlapping( AForge.Range range )
        {
            return ( ( IsInside( range.min ) ) || ( IsInside( range.max ) ) ||
        ...
        ///
        public static bool operator ==( AForge.Range range1, AForge.Range range2 )
        {
        ...
        /// <summary>
        /// Check if this instance of <see cref="AForge.Range"/> equal to the specified one.
        /// </summary>
        /// 
        ...
        {
            return ( obj is AForge.Range ) ? ( this == (AForge.Range) obj ) : false;
        }
